        ...
        <ContentTemplate>
            <div class="well" style="background-color: floralwhite">
                <div class="row">
                    ...
                    <div class="col-sm-8">
                        <a data-toggle="collapse" href="#Pnl_Team" role="button" aria-expanded="false" aria-controls="collapseExample">Add Concern</a>
                        
                           <div class="collapse" id="Pnl_Team">
                                <asp:UpdatePanel ID="UpdatePanel3" runat="server">
                                    <ContentTemplate>
                                        <div class="form-horizontal" style="background-color:aliceblue;padding:10px;">
