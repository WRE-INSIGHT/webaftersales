...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container-fluid">
        ...
        <asp:SqlDataSource ID="SqlDataSource2" runat="server" SelectCommand="
               select kno,itemno,location,specification,reportid,[description],assessment,progress,Stock_Used,Measurement,Quantity = (case when Quantity = '' then '' else Quantity+'qty' end),Breakage,Typhoon,Typhoon_Name from tblassessment as a
