            ...
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    <div class="input-group">
                        <asp:DropDownList ID="locationdl" Height="30" CssClass="form-control" runat="server"></asp:DropDownList>
                        <div class="input-group-btn">
                            <asp:LinkButton ID="LinkButton1" Height="30" CssClass="btn btn-default" runat="server" OnClick="searchbtn_Click"><span class="glyphicon glyphicon-search"></span></asp:LinkButton>
                        </div>
                    </div>
                    <br />
                                        ...
                                        <div class="panel-body">
                                            ...
                                            <table border="1" class="table">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <asp:Label ID="Label2" runat="server" Text='<%# Bind("job_order_no") %>'></asp:Label>
                                                    </td>
                                                </tr>
