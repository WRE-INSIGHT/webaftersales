<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="resealantsignature.aspx.cs" Inherits="webaftersales.AFTERSALESPROJ.resealantsignature" %>
                            ...
                            <div class="container">
                                <div class="page-header">
                                    ...
                                    <div class="navbar-right">
                                        <asp:HyperLink ID="HyperLink1" CssClass="btn btn-default" NavigateUrl="~/AFTERSALESPROJ/resealantreport.aspx" runat="server" Text="back to report"></asp:HyperLink>
                                    </div>
                                </div>
