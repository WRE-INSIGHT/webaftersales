...
{
    public partial class cuttinglistsignature : System.Web.UI.Page
    {
        ...
        private void senderbutton()
        {
            if (IsValid)
            {
                ...
                string filepath = "~/Uploads/ASuploads/" + Session["CIN"].ToString() + "/" + Session["SID"].ToString() + "/REFOILING/" + Session["refoilingqno"].ToString() + "/signature/";
