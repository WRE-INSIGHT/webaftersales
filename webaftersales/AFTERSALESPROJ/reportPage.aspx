        ...
        <ContentTemplate>
            ...
            <div class="panel panel-primary">
                <div class="panel-body">
                    ...
                    <asp:HyperLink ID="HyperLink1" CssClass="btn btn-default" runat="server" NavigateUrl="~/AFTERSALESPROJ/importPage.aspx">import items</asp:HyperLink>
                    <asp:LinkButton ID="LinkButton2" runat="server" CssClass="btn btn-default" OnClick="LinkButton2_Click">view report</asp:LinkButton>
                    <asp:LinkButton ID="LinkButton3" runat="server" CssClass="btn btn-default" OnClick="LinkButton3_Click">see photos</asp:LinkButton>
                </div>
            </div>
