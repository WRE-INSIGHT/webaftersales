            ...
            <asp:GridView ID="GridView2" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="ITEMNO" SortExpression="ITEMNO">
                        ...
                        <ItemTemplate>
                            <asp:Label ID="Label1" Width="50px" runat="server" Text='<%# Bind("ITEMNO") %>'></asp:Label>
                        </ItemTemplate>
                    ...
                    <asp:TemplateField HeaderText="KNO" SortExpression="KNO">
                        <EditItemTemplate>
                            <asp:TextBox ID="TextBox2" CssClass="tboxinput" runat="server" Text='<%# Bind("KNO") %>'></asp:TextBox>
                        </EditItemTemplate>
                        <ItemTemplate>
                            <asp:Label ID="Label2" runat="server" Text='<%# Bind("KNO") %>'></asp:Label>
                        </ItemTemplate>
                        <FooterTemplate>
                            <asp:TextBox ID="tboxkno" CssClass="tboxinput" runat="server"></asp:TextBox>
                        </FooterTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="LOCATION" SortExpression="LOCATION">
                        <EditItemTemplate>
                            <asp:TextBox ID="TextBox3" CssClass="tboxinput" runat="server" Text='<%# Bind("LOCATION") %>'></asp:TextBox>
                        </EditItemTemplate>
                        <ItemTemplate>
                            <asp:Label ID="Label3" runat="server" Text='<%# Bind("LOCATION") %>'></asp:Label>
                        </ItemTemplate>
                        <FooterTemplate>
                            <asp:TextBox ID="tboxlocation" CssClass="tboxinput" runat="server"></asp:TextBox>
                        </FooterTemplate>
                    </asp:TemplateField>
                    ...
                    <asp:TemplateField HeaderText="MOBILIZATIONCOST" SortExpression="MOBILIZATIONCOST">
                        <EditItemTemplate>
                            <asp:TextBox ID="TextBox5" CssClass="tboxinput" runat="server" Text='<%# Bind("MOBILIZATIONCOST") %>'></asp:TextBox>
                        ...
                        <FooterTemplate>
                            <asp:TextBox ID="tboxmobilizationcost" CssClass="tboxinput" runat="server"></asp:TextBox>
                ...
                <RowStyle Font-Names="Segoe UI" Font-Size="12pt" Height="50px" BackColor="#DEDFDE" ForeColor="Black" />
