<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="cleaningsignature.aspx.cs" Inherits="webaftersales.AFTERSALESPROJ.cleaningsignature" %>
                            ...
                            <div class="container">
                                <div class="page-header">
                                    ...
                                    <div class="navbar-right">
                                        <asp:HyperLink ID="HyperLink1" CssClass="btn btn-default" NavigateUrl="~/AFTERSALESPROJ/cleaningreport.aspx" runat="server" Text="back to report"></asp:HyperLink>
                                    </div>
                                </div>
