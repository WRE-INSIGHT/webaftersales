...
{
    public partial class cleaningsignature : System.Web.UI.Page
    {
        ...
        private void senderbutton()
        {
            if (IsValid)
            {
                ...
                string filepath = "~/KMDI_FILES/Aftersales/ASuploads/" + Session["CIN"].ToString() + "/" + Session["SID"].ToString() + "/CLEANING/" + Session["cleaningqno"].ToString() + "/signature/";
                ...
                string str = "update CLEANINGTBL set " + columnname + "='" + Session["userid"].ToString() + "' where ID = @ID";
                updatetb(str);
        ...
        private void updatetb(string qry)
        {
            try
            {
                ...
                using (SqlConnection sqlcon = new SqlConnection(sqlconstr))
                {
                    ...
                    {
                        sqlcon.Open();
                        sqlcmd.Parameters.AddWithValue("@ID", Session["cleaningid"].ToString());
