...
namespace webaftersales.AFTERSALESPROJ
{
    public partial class quotationreportclient : System.Web.UI.Page
    {
        ...
        private void getparameters()
        {
            ...
            string prepared = new Uri(Server.MapPath("~/KMDI_FILES/Aftersales/ASuploads/" + Session["CIN"].ToString() + "/" + Session["SID"].ToString() + "/" + aseno.ToString() + "/signature/PREPAREDBY.jpg")).AbsoluteUri;
            string approved = new Uri(Server.MapPath("~/KMDI_FILES/Aftersales/ASuploads/" + Session["CIN"].ToString() + "/" + Session["SID"].ToString() + "/" + aseno.ToString() + "/signature/APPROVEDBY.jpg")).AbsoluteUri;
            string accepted = new Uri(Server.MapPath("~/KMDI_FILES/Aftersales/ASuploads/" + Session["CIN"].ToString() + "/" + Session["SID"].ToString() + "/" + aseno.ToString() + "/signature/ACCEPTEDBY.jpg")).AbsoluteUri;
